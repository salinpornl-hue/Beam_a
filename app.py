...
with tab1:
    ...
    with c2:
        # ฐานข้อมูลวัสดุ: [Allowable Bending Stress (kg/cm²), Density (kg/m³), E (kg/cm²)]
        mat_db = {
            "เหล็กรูปพรรณ SS400 (มาตรฐานทั่วไป)": [1440.0, 7850.0, 2.0e6],   # Fy ~2,400 ksc -> Fb = 0.6Fy
            "เหล็กรูปพรรณ A36 (มาตรฐานอเมริกา)": [1500.0, 7850.0, 2.0e6],   # Fy ~2,500 ksc
            "เหล็กกำลังสูง SM520 (งานโครงสร้างหนัก)": [2160.0, 7850.0, 2.0e6], # Fy ~3,600 ksc
            "เหล็กกำลังสูง A992 / Grade 50": [2070.0, 7850.0, 2.0e6],       # Fy ~3,450 ksc
            "เหล็กรีดเย็นตัวซี (Cold-formed)": [1440.0, 7850.0, 2.0e6],      # เหล็กรูปพรรณขึ้นรูปเย็น มอก.
            "อลูมิเนียมอัลลอย (6061-T6)": [950.0, 2700.0, 0.7e6],            # เพิ่มทางเลือกสำหรับงานเบา
        ...
        st.info(f"หน่วยแรงดัด: **{sigma_allow:,.0f} kg/cm²** | ความหนาแน่น: **{density:,.0f} kg/m³** | ค่า E: **{E_val:,.0f} kg/cm²**")
